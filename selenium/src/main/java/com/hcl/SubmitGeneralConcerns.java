...
public class SubmitGeneralConcerns {
    ...
    public static void main(String[] args) {
        ...
        WebElement nextButton1 = driver.findElement(By.xpath("//button[@class='btn btn-primary next']"));
        nextButton1.click();
        ...
        // Clicking on the "Next" button
        WebElement nextButton2 = driver.findElement(By.xpath("//button[@class='btn btn-primary next']"));
        nextButton2.click();
        ...
        // Clicking on the "Next" button
        WebElement nextButton3 = driver.findElement(By.xpath("//button[@class='btn btn-primary next']"));
        nextButton3.click();

        // Verifying that "Do not add any payment information in the comment field" is displayed below the message field
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='message']"));
        ...
        WebElement submitButton = driver.findElement(By.xpath("//button[@class='btn btn-primary submit']"));
        submitButton.click();
