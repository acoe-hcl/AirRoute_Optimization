...
public class SubmitGeneralConcerns {
    ...
    public static void main(String[] args) {
        ...
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='message__content' and text()='Do not add any payment information in the comment field']"));
        ...
        assert actualPaymentInformationMessage.equals(expectedPaymentInformationMessage);
        ...
        assert actualConfirmationMessage.equals(expectedConfirmationMessage);
