...
public class SubmitGeneralConcerns {
    ...
    public static void main(String[] args) {
        ...
        WebElement paymentInfoMessage = driver.findElement(By.xpath("//div[@class='comment-message']//p[text()='Do not add any payment information in the comment field']"));
