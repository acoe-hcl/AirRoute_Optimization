...
public class SubmitGeneralConcerns {
	...
	public static void main(String[] args) {
		...
		WebElement passengerInfoHeader = driver.findElement(By.xpath("//h2[contains(text(),'Passenger Information')]"));
		...
		WebElement airlineInfoHeader = driver.findElement(By.xpath("//h2[contains(text(),'Airline Information')]"));
		...
		WebElement bookingRefField = driver.findElement(By.id("booking-reference"));
		bookingRefField.sendKeys("3ED8RH");
		...
		WebElement paymentInfoHeader = driver.findElement(By.xpath("//h2[contains(text(),'Payment Information')]"));
		...
		WebElement paymentInfoMessage = driver.findElement(By.xpath("//p[contains(text(),'Do not add any payment information in the comment field')]"));
		...
		WebElement confirmationMessage = driver.findElement(By.xpath("//p[contains(text(),'Thank you for sharing your travel experience. This is an automated response to let you know that we received your comments.')]"));
