...
public class SubmitGeneralConcerns {
    ...
    public static void main(String[] args) {
        ...
        WebElement nextButton1 = driver.findElement(By.xpath("//button[@class='button button--primary' and text()='Next']"));
        nextButton1.click();
        ...
        // Click on the "Next" button
        WebElement nextButton2 = driver.findElement(By.xpath("//button[@class='button button--primary' and text()='Next']"));
        nextButton2.click();
        ...
        // Click on the "Next" button
        WebElement nextButton3 = driver.findElement(By.xpath("//button[@class='button button--primary' and text()='Next']"));
        nextButton3.click();

        // Verify that "Do not add any payment information in the comment field" is displayed below the message field
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='field__help' and text()='Do not add any payment information in the comment field']"));
        ...
        WebElement submitButton = driver.findElement(By.xpath("//button[@class='button button--primary' and text()='Submit']"));
        submitButton.click();

        // Verify the confirmation message
        WebElement confirmationMessage = driver.findElement(By.xpath("//div[@class='message__content' and text()='Thank you for sharing your travel experience. This is an automated response to let you know that we received your comments.\nA file number has been assigned and will be emailed to you shortly. Your feedback is very important and it may take some time to research and investigate your concerns.\nWe will get back to you as soon as possible. Thank you for your patience.']"));
