...
public class SubmitGeneralConcerns {
	...
	public static void main(String[] args) {
		...
		Select provinceStateDropdown = new Select(driver.findElement(By.id("stateorprovince")));
		...
		// Enter primary phone no in the Primary Phone No Field
		...
		Select departureAirportDropdown = new Select(driver.findElement(By.id("departureairport")));
		...
		Select arrivalAirportDropdown = new Select(driver.findElement(By.id("arrivalairport")));
