...
public class AirCanadaContactUs {
    ...
    public static void main(String[] args) {
        ...
        WebElement nextButton1 = driver.findElement(By.xpath("//button[@class='next-btn']"));
        nextButton1.click();
        ...
        // Click on the "Next" button
        WebElement nextButton2 = driver.findElement(By.xpath("//button[@class='next-btn']"));
        nextButton2.click();
        ...
        // Click on the "Next" button
        WebElement nextButton3 = driver.findElement(By.xpath("//button[@class='next-btn']"));
        nextButton3.click();

        // Verify that "Do not add any payment information in the comment field" is displayed below the message field
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='payment-info-msg']"));
        ...
        WebElement confirmationMessage = driver.findElement(By.xpath("//div[@class='confirmation-msg']"));
