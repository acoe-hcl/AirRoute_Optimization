...
public class AirCanadaContactUs {
    ...
    public static void main(String[] args) {
        ...
        WebElement primaryPhoneNoField = driver.findElement(By.id("phoneNumber"));
        ...
        Select departureAirportDropdown = new Select(driver.findElement(By.id("departureAirportCode")));
        ...
        Select arrivalAirportDropdown = new Select(driver.findElement(By.id("arrivalAirportCode")));
        ...
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='field-validation-error' and text()='Do not add any payment information in the comment field']"));
        ...
        WebElement confirmationMessage = driver.findElement(By.xpath("//div[@class='alert alert-success' and contains(text(),'Thank you for sharing your travel experience. This is an automated response to let you know that we received your comments.')]"));
