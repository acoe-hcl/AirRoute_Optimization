...
public class AirCanadaContactUs {
    ...
    public static void main(String[] args) {
        ...
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='field__description' and text()='Do not add any payment information in the comment field']"));
