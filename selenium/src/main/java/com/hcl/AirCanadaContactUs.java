...
public class AirCanadaContactUs {
    ...
    public static void main(String[] args) {
        ...
        WebElement paymentInformationMessage = driver.findElement(By.xpath("//div[@class='message']/p[contains(text(),'Do not add any payment information in the comment field')]"));
        ...
        WebElement confirmationMessage = driver.findElement(By.xpath("//div[@class='message']/p[contains(text(),'Thank you for sharing your travel experience. This is an automated response to let you know that we received your comments.')]"));
